...
;  Status: Complete
;  Project files: assign6-cdriver.cpp, assign6-computehsum.asm, assign6-time.asm, assign6-macros.inc
;Module information
;  File name: assign6-asmdriver.asm
;  This module's call name: computehsum
;  Language: X86-64
;  Syntax: Intel
...
;Preconditions: rdi holds start, rsi holds last term to compute to, rdx holds address to dereference for saving last term
;Postconditions: xmm0 holds the sum, rdi holds 
...
mov        rax, adddenominatorsby                           ;;Bug in macho64 won't allow [adddenominatorsby] dereference
vaddpd     ymm14, [rax]                                     ;Add to denominators by 0.0, 1.0, 2.0, 3.0 to initialize initial denominators

mov        rax, increment                                   ;;Bug in macho64 won't allow [increment] dereference
...
domoreterms:                                                ;Label for term computation loop
  cmp      rdi, rsi                                         ;Compare highest denominator value with number of terms to compute 
                                                                ;TODO: Need to figure out how to do xmm compare correctly, ymm14 versus ymm1
...
;======== Send value to double reference parameter ========================================================================================================================

;showymmregisters 1

movsd      [rdx], xmm11                                     ;As rdx holds the address to the last_term in C, send a copy of the last term this way
