...
computehsum:                                               ;Entry point.  Execution begins here.
...
vmovupd    ymm15, [numerators]                              ;Set up numerator values in ymm15 (1.0, 1.0, 1.0, 1.0)
...
vaddpd     ymm14, [adddenominatorsby]                       ;Add to denominators by 0.0, 1.0, 2.0, 3.0 to initialize initial denominators
